...
#These screens are the main menu and selection respectively

def Screen1and2():
	window = Tk()
	window.geometry('640x360')
	window.title('Titanic Survival Menu Interface')
	instruction = Label(window, text = "Choose an option from the list below, then press 'Select'", font = 'Helvetica 13 bold')
	frame = Frame(window)
...
#Here I am putting the entires into a listbox for the user to select from
	...
	selection = ''
#This subroutine creates screen 2
	def dialog():
		...
		if var == 1:
			...
			window.destroy()
#Packing features
	btn = Button(frame, text = 'SELECT', command = dialog, font = 'Helvetica 13 bold')
...
#This subroutine draws up Screen 4
def Screen4():
...
#This checks probability of survival
    def predictor(profile):
        ...
        window.destroy()
#This contains the window features, each variable is a different features
    window = Tk()
    ...
    mainlabel = Label(window, text = '''Welcome to the Profile Check.
        ...
        using the buttons on the side and below:''', font = 'Helvetica 13')
    ...
    btn1 = Button(window,text = 'CHECK', command = check_pclass, font = 'Helvetica 11 bold')
    btn2 = Button(window,text = 'CHECK', command = check_sex, font = 'Helvetica 11 bold')
    btn3 = Button(window,text = 'CHECK', command = check_age, font = 'Helvetica 11 bold')
    btn4 = Button(window,text = 'CHECK', command = check_sibsp, font = 'Helvetica 11 bold')
    btn5 = Button(window,text = 'CHECK', command = check_parch, font = 'Helvetica 11 bold')
    btn6 = Button(window,text = 'CHECK', command = check_fare, font = 'Helvetica 11 bold')
    btn7 = Button(window,text = 'CHECK', command = check_embarked, font = 'Helvetica 11 bold')
    btn8 = Button(window,text = 'PREDICT...', command = check_all, font = 'Helvetica 11 bold')
...
#This outputs the profile and predicted survival
	...
	def predict():
		...
		box.showinfo('Prediction', concatanate)
		window.destroy()
#Code here contains window features
	window = Tk()
	...
	entry1 = Entry(window)
	btn1 = Button(window, text = 'PREDICT', command = check_answer, font = 'Helvetica 12 bold')
...
#Because each window is separate it needs its own back function
	...
	btn1 = Button(window, text = 'BACK', command = goback, font = 'Helvetica 13 bold')
	label1.pack()
	label2.pack()
	btn1.pack()
	window.mainloop()
...
#Screen 10's code, this screen was created after initial design
def Screen10():
	def goback():
		window.destroy()
	window = Tk()
